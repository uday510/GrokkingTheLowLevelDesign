...
import DesignPatterns.Adapter.example.adapter.USB_A;
import DesignPatterns.Adapter.example.adapter.USB_C_Device;
import DesignPatterns.Adapter.example.adapter.USB_C_to_USB_A_Adapter;
